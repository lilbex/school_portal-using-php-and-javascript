	...
	
{
	...
	/////this function takes care of student image............
	...
	////////// view all students in admin  //////////////////////////
	public function view_all_students_admin($class_students_data)
	{
	...
	public function add_student($std_fullname,$std_username,$std_password,$std_grade,$std_roll,$std_dob,$std_address,$std_district,$std_gender,$std_father,$std_mother,$std_parent_contact,$std_datetime_admitted,$std_formerschool,$filenewDestination)
	{
		$add_student_insert = "insert into st_info(st_fullname,st_username,st_password,st_grade,roll_no,st_dob,st_address,st_district,st_gender,st_father,st_mother,st_parents_contact,st_datetime_admitted,st_formerschool,st_image) value('$std_fullname','$std_username','$std_password','$std_grade','$std_roll','$std_dob','$std_address','$std_district','$std_gender','$std_father','$std_mother','$std_parent_contact'$std_datetime_admitted,$filenewDestination)";
	...
	public function update_student_info($up_fullname,$up_username,$up_password,$up_grade,$up_gender,$up_roll,$up_dob,$up_address,$up_formerschool,$up_district,$up_father,$up_mother,$up_parents_contact,$up_assignment,$student_id)
	{
		$update_student_info_select = "update st_info set t_fullname='$up_fullname',st_username='$up_username',st_password='$up_password',st_grade='$up_grade',st_gender='$up_gender',st_roll='$up_roll',st_dob='$up_dob',st_address='$up_address',st_formerschool_type='$up_formerschool',t_district='$up_district',st_father='$up_father',st_mother='$up_mother',parents_contact='$up_parents_contact',$st_assignment='$up_assignment' where st_id='$student_id'";
	...
	{
		$edit_studentid = "select * from teacher_info where t_id='$teacher_id'";
