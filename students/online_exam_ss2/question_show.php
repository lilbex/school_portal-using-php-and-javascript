        ...
        <nav class="navbar navbar-light sticky-top navbar-expand-md navigation-clean-button bg-light">
            <div class="container"><a class="navbar-brand" href="index.php"><img class="img-responsive" src="assets/img/brand.svg" width="30px" height="30px"> Quiz System</a><a class="navbar-brand" href="../index.php"><?php echo $st_name ?></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse"
                    ...
                    <ul class=" navbar-nav ml-auto"><span class="navbar-text actions"> <a href="#" class="login">Log In</a><a class="btn btn-light action-button" role="button" href="#">Sign Up</a></span></div>
            </div>
        </nav>
    </div>
<br/>
...
<div class="row">
    ...
    <div class="container">
    	...
    	<?php 
           $s_sn = 1;
        foreach ($ques->ques as $question)

    	{ ?>
    	<table class="table table-borderless">
    		<thead>
    			<tr>
    				<th><?php echo $s_sn; ?>.<?php echo $question['question']?></th>
    			</tr>
    		</thead>
    		<tbody>
