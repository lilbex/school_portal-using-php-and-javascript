    		...
    		<div class="col-md-6">
    			<div class="jumbotron" style="background-color: #F8F9FA; font-weight: bold;">
                    ...
                    <form method="POST" action="post_answer.php" >
                        <input type="hidden" name="st_id" value="<?php echo $st_id; ?>" placeholder="st_id">
                        <input type="hidden" name="class_id" value="<?php echo $class_id; ?>" placeholder="class_id">
                        <input type="hidden" name="st_score" value="<?php  echo $score; ?>">
                     
                        <button class="btn" name="submit" type="Submit"  style="color:white;background-color: #56C6C6;display: block; margin: 0 auto;">Submit Result</button>
                    </form> 
