...
<body>
    <div>
        <nav class="navbar navbar-light sticky-top navbar-expand-md navigation-clean-button bg-light">
            <div class="container"><a class="navbar-brand" href="index.php"><img class="img-responsive" src="assets/img/brand.svg" width="30px" height="30px"> Quiz System</a><a class="navbar-brand" href="../index.php"><?php echo $st_name ?></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse"
                    id="navcol-1">
                    
                    <ul class=" navbar-nav ml-auto"><span class="navbar-text actions"> <a href="#" class="login">Log In</a><a class="btn btn-light action-button" role="button" href="signup.php">Sign Up</a></span></div>
            </div>
        </nav>
    </div>
<!--Main Content Start--> 
...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    <li class=" nav-item nav-link"><a data-toggle="tab" href="#home" style="text-decoration: none;">Click here for class</a></li>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
        <form class="form w-auto" action="question_show.php" method="post">
            ...
            <div class="col-md-4">
            <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Select Class</label>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row"><?php echo $st_id?></th>
