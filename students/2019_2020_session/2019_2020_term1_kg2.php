<!-- modal -->
<div class="modal about-modal w3-agileits fade" id="mykg2" tabindex="-1" role="dialog">
    ...
    <table  class="table table-bordered table-striped">
        ...
        <t>
         ...
         <tr>
            ...
            <tr>
            <td>Health Edu.</td>
            <td><?php echo $rows['Health1']; ?></td>
            <td><?php echo $rows['Health2']; ?></td>
            <td><?php echo $rows['HealthP']; ?></td>
            <td><?php echo $rows['Hedu']; ?></td>
            <td><?php echo $rows['HealthTotal']; ?></td>
            <td><?php echo $rows['HealthGrade']; ?></td>
            </tr>
            <tr>
  <tr>
            <td>Writing</td>
