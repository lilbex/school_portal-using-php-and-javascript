...
<?php include_once'2019_2020_session/2019_2020_term1_basic1.php' ?>
    ...
    if ($resultCheckP===0) {
      ...
      <?php include_once'2019_2020_session/2019_2020_term1_basic4.php' ?>
        ...
        if ($resultCheckJ === 0) {
           $sqlN = "SELECT * FROM 2019_2020_term2_kg1_diamond_ruby WHERE st_id= '$st_id'";
  ...
  <?php include_once'2019_2020_session_term2/2019_2020_term2_kg1_diamon_ruby.php' ?>
...
?>
<?php include_once'2019_2020_session/2019_2020_term1_basic5.php' ?>
...
if ($resultCheckj2===0) {
   $sqlprekg="SELECT * FROM 2019_2020_term2_prekg WHERE st_id= '$st_id'";
...
if($resultCheckprekg===1){
    while ( $rows=mysqli_fetch_assoc($resultprekg)) {
       ?>
<?php include_once'2019_2020_session_term2/2019_2020_term2_prekg.php' ?>    
       <?php
    }
}
...
<?php include_once'2019_2020_session/2019_2020_term1_basic2.php' ?>
    ...
    if ($resultCheckpry2===0) {
        $sqlnur2="SELECT * FROM 2019_2020_term2_kg2 WHERE st_id= '$st_id'";
    ...
    if($resultChecknur2===1){
        while ($rows=mysqli_fetch_assoc($resultnur2)) {
           ?>
<?php include_once'2019_2020_session_term2/2019_2020_term2_kg2.php' ?>
           <?php
        }
    }
